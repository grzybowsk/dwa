insert into user values(1, 'Computer Science', 'Kindson Munonye', 'The Tech Pro', 'Data Science');
insert into user values(2, 'Managment', 'Kate Winston',  'The Tech Pro', 'Data Science');
insert into user values(3, 'Data Science', 'Solace Okeke', 'The Tech Pro', 'Data Science');
